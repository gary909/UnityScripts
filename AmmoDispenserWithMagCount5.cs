...
namespace BNG {
    ...
    /// V4 Added Shotgun shell count + text colour change on low ammo
    /// V5 Added Rifle count + text colour change on low ammo
    /// </summary>
    public class AmmoDispenser : MonoBehaviour {
        ...
        bool grabberHasWeapon(Grabber g) {
            ...
            if (grabName.Contains("Shotgun") || grabName.Contains("Pistol") || grabName.Contains("Rifle")) {
                UiPistolMagCountTMP.text = CurrentPistolClips.ToString() + "0"; // ***TMP Text: Sets the starting amount of Pistol magazines on the canvas***
                ...
                UiRifleMagCountTMP.text = CurrentRifleClips.ToString() + "0"; // ***TMP Text: Sets the starting amount of Rifle magazines on the canvas***
                return true;
            }
