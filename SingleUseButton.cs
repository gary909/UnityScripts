...
namespace BNG
{
    ...
    // ***** This script is based on the regular button script but now once clicked, the button stays in place, lots of original code commented out ******
    /// </summary>
    public class SingleUseButton : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (grabberInButton || UITriggerInButton)
            {
                ...
                {
                    joint.spring = 0;
                    //MaxLocalY = 0.26f; // **** Set the button to stick at min height *******
                }
            }
            /*else
            {
