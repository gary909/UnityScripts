...
public class UI_KeyHolder : MonoBehaviour
{
    ...
    private void UpdateVisual()
    {
        ...
        for(int i = 0; i < keyList.Count; i++)
        {
            ...
            keyTransform.gameObject.SetActive(true); // Test if working - changed from keyTemplate to keyTransform at start of sentence
            keyTransform.GetComponent<RectTransform>().anchoredPosition = new Vector2(25 * i, 0);
